# La carte avant la marche

### Le nombre de projet
* **273** projets au total
...
|ConsoleApp   |   98|
|TestSuite    |   60|
||273|***Projets déclarés***|

### Le nombre de chaîne de compilation

* Il y'a `5 chaines de compilation`.
...
<div align="center">
Encore désolé pour la répétiton, je l'ai fait penser que la note qui s'affichait allait changer pour devenir la note que vous avez mis, car c'est une note inférieure à la nouvelle note.
<div>